...
def main():
    ...
    text_proj_params = model.text_proj()
    text_proj_grp = {'params': text_proj_params}

    img_proj_params = model.img_proj()
    img_proj_grp = {'params': img_proj_params}


    sgd_polices = [text_proj_grp, img_proj_grp]
